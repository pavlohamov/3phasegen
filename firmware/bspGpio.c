...
static const BspGpioConfig_t s_gpioConfig[] = {
    ...
    [BSP_Pin_UART_TX] = { GPIOA, { GPIO_Pin_9, GPIO_Mode_AF,
        GPIO_Speed_Level_1, GPIO_OType_PP,  GPIO_PuPd_NOPULL} },
    [BSP_Pin_UART_RX] = { GPIOA, { GPIO_Pin_10, GPIO_Mode_AF,
	...
	[BSP_Pin_POL_1] = { GPIOF, { GPIO_Pin_0, GPIO_Mode_OUT,
		GPIO_Speed_Level_1, GPIO_OType_PP,  GPIO_PuPd_NOPULL} },

	[BSP_Pin_POL_2] = { GPIOA, { GPIO_Pin_5, GPIO_Mode_OUT,
		GPIO_Speed_Level_1, GPIO_OType_PP,  GPIO_PuPd_NOPULL} },

	[BSP_Pin_POL_3] = { GPIOA, { GPIO_Pin_4, GPIO_Mode_OUT,
		GPIO_Speed_Level_1, GPIO_OType_PP,  GPIO_PuPd_NOPULL} },


	[BSP_Pin_LedYellow] = { GPIOA, { GPIO_Pin_2, GPIO_Mode_OUT,
		GPIO_Speed_Level_1, GPIO_OType_PP,  GPIO_PuPd_NOPULL} },
	[BSP_Pin_LedRed] = { GPIOA, { GPIO_Pin_3, GPIO_Mode_OUT,
		GPIO_Speed_Level_1, GPIO_OType_PP,  GPIO_PuPd_NOPULL} },


	[BSP_Pin_Adc_0] = { GPIOA, { GPIO_Pin_0, GPIO_Mode_IN,
		GPIO_Speed_Level_1, GPIO_OType_PP,  GPIO_PuPd_NOPULL} },
	[BSP_Pin_Adc_1] = { GPIOA, { GPIO_Pin_1, GPIO_Mode_IN,
		GPIO_Speed_Level_1, GPIO_OType_PP,  GPIO_PuPd_NOPULL} },
